...
export default function Hero() {
  return (
    <section className="relative overflow-hidden flex flex-col items-center justify-center min-h-screen text-center px-4">
      ...
      <img
        src="/blob_kiri.svg"
        className="absolute bottom-0 left-0 w-[45%] max-w-[300px] pointer-events-none select-none z-10"
      />
      ...
      <div className="relative z-20 flex flex-col items-center max-w-6xl w-full">
        ...
        <div className="flex flex-col items-start space-y-8 relative">
          ...
          {/* Garis vertikal */}
          <div className="absolute left-[20px] top-4 bottom-4 w-[2px] bg-gray-200 -z-10 hidden md:block"></div>
          ...
          {/* PRIORITASKAN */}
          <div className="flex items-center gap-6 translate-x-4 md:translate-x-8">
            <div className="bg-white p-2 rounded-lg shadow-sm">
