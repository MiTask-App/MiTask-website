          ...
          <div className="mt-0.5 text-blue-600">
            ...
            >
              <path
                ...
                d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.835a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"
              />
            </svg>
          </div>
          <div>
            ...
            <p className="text-xs text-blue-700 leading-relaxed mt-1">
              Dashboard ini khusus untuk pengguna terdaftar. Pastikan kamu sudah
              membuat akun melalui 'Aplikasi MiTask' sebelum mencoba masuk.
            </p>
          </div>
        </div>
        {/* --- END ALERT BOX --- */}

        <div className="bg-white p-8 md:p-12 rounded-lg shadow-sm border border-gray-100 w-full">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <a
              href="/"
              className="w-full text-center block mt-4 text-sm font-medium text-slate-400 hover:text-blue-600 transition-colors"
            >
              Kembali ke Beranda
            </a>
          </form>
